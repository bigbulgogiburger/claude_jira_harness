...
description: "Use PROACTIVELY when writing tests or when test coverage is needed. Guides JUnit 5, @CustomRepositoryTest, Mockito patterns. Never modifies production code."
model: sonnet
tools: Read, Grep, Glob, Bash
---
